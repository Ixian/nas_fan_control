...
# Modified from this script: https://github.com/sretalla/nas_fan_control 
# Setup instructions/pre-reqs:
#
...
# Further modified by @ixian for Ubuntu Linux servers
